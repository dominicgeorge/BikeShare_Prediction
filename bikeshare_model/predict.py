...
if __name__ == "__main__":
    ...
    data_in={'dteday':["2012-11-05"],'season':["winter"],'hr':["6am"],'holiday':["No"],'weekday':['Mon'],'workingday':['Yes'],'weathersit':['Mist'],
                'temp':[6.10],'atemp':[3.0014],'hum':[49.0],'windspeed':[19.0012],'casual':[4],'registered':[135]}
